...
<section id="content">
   <section class="main padder">
      <div class="clearfix">
         <h4><i class="fa fa-edit"></i>View Employee</h4>
      </div>
      <?php
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-8">
						 <?php
							...
							?>
                        <input type="text" name="emp_telephone" maxlength="13" placeholder="Telephone" value="<?php echo set_value('emp_telephone');?><?php if($showtel=='yes'){  if(!empty($confData[0]->emp_telephone )){ echo trim($confData[0]->emp_telephone);} } else { echo "********"; }?>" <?php if($showtel=='no'){ echo "readonly";}?> data-required="true"  class="form-control">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-8">
						 <?php
							...
							?>
                        <input type="text" name="emp_mobile" data-type="number" maxlength="10"  placeholder="Mobile Phone" value="<?php echo set_value('emp_mobile'); ?><?php if($showPhone=='yes') { if(!empty($confData[0]-> emp_mobile)){ echo trim($confData[0]-> emp_mobile); } }else{  echo "*******"; }?>"  <?php if($showPhone=='no'){ echo "readonly";}?> data-required="true"  class="form-control">
                         <div class="checkbox">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-8">
						 <?php
							...
							?>
                        <input type="text" name="emp_email" maxlength="60" placeholder="E-Mail" value="<?php echo set_value('emp_email');  if($showEma==='yes'){ if(!empty($confData[0]->emp_email)){ echo trim($confData[0]->emp_email); } }else{ echo "********"; }?>"  <?php if($showEma=='no'){ echo "readonly";}?> data-required="true "  class="form-control" data-type="email">
                        <div class="checkbox">
