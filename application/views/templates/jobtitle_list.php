 <section id="content">
    <section class="main padder">
      <div class="clearfix">
        <h4><i class="fa fa-table"></i>Job Title List</h4>
        <div class="addLink"><a href="<?php echo base_url();?>jobtitle/add_jobtitle">Add Job Title</a></div>
      </div>
			...
			<?php
			  ...
			  ?>
				  <div class="alert alert-success">
					 ...
					 <i class="fa fa-check fa-lg"></i><strong>Well done!</strong> You successfully <?php echo $returnMSG;?> the jobtitle</a>.
				  </div>
			<?php } ?>
            ...
            <div class="table-responsive">
              <table class="table table-striped m-b-none datatablessasd" >
                ...
                <tbody>
					...
					<tr>
					<td><?php echo $i; ?></td>
                    <td><?php echo $confData->job_value;?></td>
                    <td align="center">
						<a href="<?php echo base_url();?>jobtitle/edit_jobtitle/<?php echo $confData->job_id; ?>"><i class="fa fa-pencil"></i></a>&nbsp;
						<a href="javascript:void(0);" onclick="deleteJobtitle(<?php echo $confData->job_id; ?>);" ><i class="fa fa-times-circle"></i></a> 
                    </td>
				</tr>
				<?php 
					$i++;
...
<script type="text/javascript" >
	...
	function deleteJobtitle(mainId){	
	...
	else
	{
		jQuery.ajax({
			type: "POST",
			url: '<?php echo base_url();?>jobtitle/delete_jobtitle/'+mainId,
			data: {
				payment_id: mainId
			},
			beforeSend: function () {
			...
			success: function (msg) {
					window.location = "<?php echo base_url();?>jobtitle/";
